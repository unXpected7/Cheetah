...
import { RegisterRequest } from '../types/chat';
...
const AuthRegister: React.FC<AuthRegisterProps> = ({ onRegister, onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await mockChatApi.register(formData);
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Sign up to start messaging</p>
      </div>
      ...
      <div className="mt-8 p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>• Username must be at least 2 characters</li>
